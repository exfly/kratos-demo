...
type Monitor struct {
	...
	Tracer *Monitor_Tracer `protobuf:"bytes,1,opt,name=tracer,proto3" json:"tracer,omitempty"`
}
...
func (x *Monitor) GetTracer() *Monitor_Tracer {
	if x != nil {
		return x.Tracer
	}
	return nil
...
func (x *Monitor_Tracer) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Monitor_Tracer) ProtoMessage() {}

func (x *Monitor_Tracer) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Monitor_Tracer.ProtoReflect.Descriptor instead.
func (*Monitor_Tracer) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{2, 0}
}

func (x *Monitor_Tracer) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
var file_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x74, 0x72, 0x61, 0x70, 0x12, 0x2d, 0x0a, 0x07, 0x6d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61,
	0x70, 0x69, 0x2e, 0x4d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x52, 0x07, 0x6d, 0x6f, 0x6e, 0x69,
	0x74, 0x6f, 0x72, 0x12, 0x2a, 0x0a, 0x06, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x18, 0x01, 0x20,
	...
	0x22, 0x59, 0x0a, 0x07, 0x4d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x12, 0x32, 0x0a, 0x06, 0x74,
	0x72, 0x61, 0x63, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x6b, 0x72,
	0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x4d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72,
	0x2e, 0x54, 0x72, 0x61, 0x63, 0x65, 0x72, 0x52, 0x06, 0x74, 0x72, 0x61, 0x63, 0x65, 0x72, 0x1a,
	0x1a, 0x0a, 0x06, 0x54, 0x72, 0x61, 0x63, 0x65, 0x72, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x72, 0x6c,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x22, 0xdd, 0x02, 0x0a, 0x04,
	...
	0x72, 0x69, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x42, 0x1f, 0x5a, 0x1d, 0x68,
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	6,  // 5: kratos.api.Monitor.tracer:type_name -> kratos.api.Monitor.Tracer
